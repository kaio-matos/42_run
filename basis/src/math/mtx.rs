...
impl std::fmt::Display for Mat4 {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        writeln!(f, "Mat4 {{")?;
        writeln!(f, "     {: <10} {: <10} {: <10} {: <10}", self.c0.x, self.c1.x, self.c2.x, self.c3.x)?;
        writeln!(f, "     {: <10} {: <10} {: <10} {: <10}", self.c0.y, self.c1.y, self.c2.y, self.c3.y)?;
        writeln!(f, "     {: <10} {: <10} {: <10} {: <10}", self.c0.z, self.c1.z, self.c2.z, self.c3.z)?;
        writeln!(f, "     {: <10} {: <10} {: <10} {: <10}", self.c0.w, self.c1.w, self.c2.w, self.c3.w)?;
        write!(f, "}}")
        // write!(f, "Mat4 {{\n")?;
        // write!(f, "  c0: {:?}\n", self.c0)?;
        // write!(f, "  c1: {:?}\n", self.c1)?;
